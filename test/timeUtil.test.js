...
test('getTimeArray', () => {
  ...
  expect(timeUtil.getTimeArray('2022-06-21 12:00:00', '2022-06-21 16:00:00', 'hours', 1, 'YYYY-MM-DD HH:00')).toEqual(
    ['2022-06-21 12:00', '2022-06-21 13:00', '2022-06-21 14:00', '2022-06-21 15:00', '2022-06-21 16:00'],
  );
});
